...
public class UselessGold extends ArmorItem {
    // effects, tick, level
    private final MobEffectInstance SATURATION = new MobEffectInstance(MobEffects.SATURATION, 40, 4);
    private final MobEffectInstance REGENERATION = new MobEffectInstance(MobEffects.REGENERATION, 40, 4);
    private final MobEffectInstance DAMAGE_RESISTANCE = new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 4);
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("item.leather_mod.useless_gold.tooltip").withStyle(ChatFormatting.GOLD));
